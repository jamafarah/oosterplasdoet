...
@section('content')
    ...
    <div class="container">
        ...
        {!! Form::open(array('route' => 'updatemedewerker', 'class' => 'form', 'enctype'=>"multipart/form-data")) !!}


        {!! Form::hidden('id', $medewerker->id, ['readonly']) !!}


        <div class="form-group">
            {!! Form::label('naam', 'naam') !!}
            {!! Form::text('naam', $medewerker->naam, ['required'=>'required', 'class'=>'form-control' ]) !!}
        </div>


        <div class="form-group">
            {!! Form::label('rol', 'rol') !!}
            {!! Form::text('rol', $medewerker->rol, ['required'=>'required', 'class'=>'form-control']) !!}
        </div>
        ...
        <div class="form-group">
            ...
            {!! Form::textarea('beschrijving', $medewerker->beschrijving, ['required'=>'required', 'class'=>'form-control','name'=>'beschrijving']) !!}
        </div>
